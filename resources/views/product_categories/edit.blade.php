    ...
    <div class="card">
        ...
        <div class="container-fluid">
            ...
            <div class="card-header" style="margin-top:20px; background-color:blue">
              ...
              <p><h4 style="text-align:center; color:yellow">Edit data of {{$product_category->title}}</h1><p>
            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <form method='POST' enctype="multipart/form-data" action='{{route('product_category.update', [$product_category])}}' >
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-6"> 
                      ...
                      <input class="form-control" type='text' name="title" value='{{$product_category->title}}'/>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <input class="form-control" type='text' name="description" value='{{$product_category->description}}'/>
                      
                      @csrf
                        <p><p>
                        <button class="btn" style="width:100px; color:yellow; background-color:blue" type='submit'>Update</button>
                        <a class="btn" style="width:100px; color:blue; background-color:yellow"  href="{{route('product_category.index')}}">Back</a>
                    </div>
